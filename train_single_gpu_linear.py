...
def main(args):
    ...
    if os.path.exists("./weights_cls_v"+str(version)) is False:
        os.makedirs("./weights_cls_v"+str(version))
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights_cls_v{}/model-{}.pth".format(version, epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/yzbj10/Work/lxj/deep-learning-for-image-processing/pytorch_classification/mini_imagenet/weights_rep_v6/model-89.pth',
