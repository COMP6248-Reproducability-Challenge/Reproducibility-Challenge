...
def main(args):
    ...
    if os.path.exists("./weights_fully") is False:
        os.makedirs("./weights_fully")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights_fully/model-{}.pth".format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/yzbj10/Work/lxj/deep-learning-for-image-processing/pytorch_classification/mini_imagenet/weights_rep/model-89.pth',
